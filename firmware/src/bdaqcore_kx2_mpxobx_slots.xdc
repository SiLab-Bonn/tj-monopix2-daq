...
##### DATA #####
# MPXOBX (Slot 7 on Backplane) connected to SelectIOs
set_property PACKAGE_PIN G12 [get_ports {J_DATA_P[0]}]
set_property PACKAGE_PIN F12 [get_ports {J_DATA_N[0]}]
set_property PACKAGE_PIN E13 [get_ports HITOR_P]
set_property PACKAGE_PIN E12 [get_ports HITOR_N]
set_property PACKAGE_PIN D14 [get_ports {J_CMD_P[0]}]
set_property PACKAGE_PIN D13 [get_ports {J_CMD_N[0]}]
set_property PACKAGE_PIN C14 [get_ports {J_CMD_CLK_P[0]}]
set_property PACKAGE_PIN C13 [get_ports {J_CMD_CLK_N[0]}]

# NOT needed?
set_property PACKAGE_PIN D19 [get_ports {J_SER_CLK_P[0]}]
set_property PACKAGE_PIN D20 [get_ports {J_SER_CLK_N[0]}]

set_property IOSTANDARD LVDS_25 [get_ports J_SER_CLK*]
...
# # Enable and Reset for testslot BDAQcore v0.1
