...
set_property PACKAGE_PIN M17 [get_ports {mDP_GPIO_P[3]}]
set_property PACKAGE_PIN L18 [get_ports {mDP_GPIO_N[3]}]
set_property PACKAGE_PIN K16 [get_ports {mDP_GPIO_P[2]}]
set_property PACKAGE_PIN K17 [get_ports {mDP_GPIO_N[2]}]
set_property PACKAGE_PIN J18 [get_ports {mDP_GPIO_P[1]}]
set_property PACKAGE_PIN J19 [get_ports {mDP_GPIO_N[1]}]
# set_property IOSTANDARD LVDS_25 [get_ports mDP_GPIO*]
set_property PACKAGE_PIN K20 [get_ports mDP_GPIO_AUX_P]
set_property PACKAGE_PIN J20 [get_ports mDP_GPIO_AUX_N]
