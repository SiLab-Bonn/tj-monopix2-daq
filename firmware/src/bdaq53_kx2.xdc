...
set_clock_groups -asynchronous -group BUS_CLK_PLL -group I2C_CLK -group {CLK125PLLTX CLK125PLLTX90} -group {CLK320_PLL CLK160_PLL CLK40_PLL CLK16_PLL} -group [get_clocks -include_generated_clocks CLK_MGT_REF] -group [get_clocks -include_generated_clocks CLK_SMA] -group CLK_RGMII_RX
