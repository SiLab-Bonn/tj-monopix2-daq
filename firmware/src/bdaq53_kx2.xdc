...
set_property PACKAGE_PIN F19 [get_ports {J_DATA_P[1]}]
set_property PACKAGE_PIN E20 [get_ports {J_DATA_N[1]}]
...
set_property PACKAGE_PIN K20 [get_ports {J_DATA_P[2]}] 
set_property PACKAGE_PIN J20 [get_ports {J_DATA_N[2]}]
...
# set_property PACKAGE_PIN C13 [get_ports {J_GPIO_CLK_CMD_N[0]}]
# set_property PACKAGE_PIN D14 [get_ports {J_GPIO_CMD_P[0]}]
# set_property PACKAGE_PIN D13 [get_ports {J_GPIO_CMD_N[0]}]

# These are checked already
