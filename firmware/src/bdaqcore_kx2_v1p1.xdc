...
set_property PACKAGE_PIN C16 [get_ports {J_CMD_P[0]}]
set_property PACKAGE_PIN B16 [get_ports {J_CMD_N[0]}]
set_property PACKAGE_PIN B17 [get_ports {J_CMD_CLK_P[0]}]
set_property PACKAGE_PIN A17 [get_ports {J_CMD_CLK_N[0]}]
set_property PACKAGE_PIN E18 [get_ports {J_SER_CLK_P[0]}]
set_property PACKAGE_PIN D18 [get_ports {J_SER_CLK_N[0]}]
set_property PACKAGE_PIN A18 [get_ports {J_DATA_P[0]}]
set_property PACKAGE_PIN A19 [get_ports {J_DATA_N[0]}]
