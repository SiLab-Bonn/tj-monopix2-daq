...
///////////////////////////////////////////////////////////////////////////////
//
// modified to add readout of VPVN
//
///////////////////////////////////////////////////////////////////////////////
...
module xadc_ug480 (
    ...
    output reg [15:0] MEASURED_TEMP, // FPGA internal temperature
    output reg [15:0] MEASURED_VCCINT,
    output reg [15:0] MEASURED_VPVN, // voltage on dedicated VP, VN analog inputs
    ...
    parameter       init_read       = 8'h00,
                    ...
                    read_reg06      = 8'h0c,
                    reg06_waitdrdy  = 8'h0d,
                    read_reg10      = 8'h0e,
                    reg10_waitdrdy  = 8'h0f,
                    read_reg11      = 8'h10,
                    reg11_waitdrdy  = 8'h11,
                    read_reg12      = 8'h12,
                    reg12_waitdrdy  = 8'h13,
                    read_reg13      = 8'h14,
                    reg13_waitdrdy  = 8'h15;
...
XADC #(// Initializing the XADC Control Registers
    .INIT_40(16'h9000),// averaging of 16 selected for external channels, unippolar sampling
    .INIT_41(16'h2ef0),// Continuous Seq Mode, Disable unused ALMs, Enable calibration
    .INIT_42(16'h0600),// Set DCLK divides
    .INIT_48(16'h4901),// CHSEL1 - enable Temp VCCINT, VCCAUX, VCCBRAM, VPVN and calibration
    ...
    .INIT_50(16'hb5ed),// Temp upper alarm trigger 85\B0C
    .INIT_51(16'h5999),// Vccint upper alarm limit 1.05V
    .INIT_52(16'hA147),// Vccaux upper alarm limit 1.89V
    .INIT_53(16'hdddd),// OT upper alarm limit 125\B0C - see Thermal Management
    .INIT_54(16'ha93a),// Temp lower alarm reset 60\B0C
    .INIT_55(16'h5111),// Vccint lower alarm limit 0.95V
    .INIT_56(16'h91Eb),// Vccaux lower alarm limit 1.71V
    .INIT_57(16'hae4e),// OT lower alarm reset 70\B0C - see Thermal Management
    .INIT_58(16'h5999),// VCCBRAM upper alarm limit 1.05V
    .SIM_MONITOR_FILE()// Analog Stimulus file for simulation
)
