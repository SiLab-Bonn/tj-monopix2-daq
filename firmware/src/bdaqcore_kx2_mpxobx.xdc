...
##### DATA #####
# MPXOBX (Testslot on adapter) connected to SelectIOs
set_property PACKAGE_PIN G19 [get_ports {J_DATA_P[0]}]
set_property PACKAGE_PIN F20 [get_ports {J_DATA_N[0]}]
set_property PACKAGE_PIN L19 [get_ports HITOR_P]
set_property PACKAGE_PIN L20 [get_ports HITOR_N]
set_property PACKAGE_PIN K20 [get_ports {J_CMD_P[0]}]
set_property PACKAGE_PIN J20 [get_ports {J_CMD_N[0]}]
set_property PACKAGE_PIN M17 [get_ports {J_CMD_CLK_P[0]}]
set_property PACKAGE_PIN L18 [get_ports {J_CMD_CLK_N[0]}]
