...
class Tjmonopix2UsbBusDriver(BusDriver):
    ...
    def read(self, address, size, dtype="u"):
        ...
        if(address >= self.BASE_ADDRESS_I2C and address < self.HIGH_ADDRESS_I2C):
            #self.entity._log.warning("I2C address space supported in simulation! 0x{0:x}".format(address))
