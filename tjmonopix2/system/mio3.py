...
class MIO3(Dut):
    ...
    def init(self, **kwargs):
        ...
        # TODO: get daq version
        # self.fw_version, self.board_version, self.board_options, self.connector_version = self['system'].get_daq_version()
        # # self.log.info(self.num_rx_channels)
        ...
        # # self.log.info('Board has %d receiver channels' % self.num_rx_channels)
