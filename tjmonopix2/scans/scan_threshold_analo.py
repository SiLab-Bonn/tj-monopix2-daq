...
scan_configuration = {
    'start_column': 0,  # All pixels in range will be injected at the same time! 
    'stop_column': 1,
    'start_row': 508,
    'stop_row': 512,
...
class ThresholdScan(ScanBase):
    ...
    def _configure(self, start_column=0, stop_column=512, start_row=0, stop_row=512, **_):
        ...
        # TODO Enable analog output and injection to analog pixels
    ...
    def _scan(self, n_injections=100, VCAL_HIGH=80, VCAL_LOW_start=80, VCAL_LOW_stop=40, VCAL_LOW_step=-1, **_):
        ...
        for scan_param_id, vcal_low in enumerate(vcal_low_range):
            ...
            with self.readout(scan_param_id=scan_param_id):
                self.chip.inject(PulseStartCnfg=19, PulseStopCnfg=19+512, repetitions=n_injections, wait_cycles=1, latency=1400) #questa è la parte modificata
        pbar.close()
