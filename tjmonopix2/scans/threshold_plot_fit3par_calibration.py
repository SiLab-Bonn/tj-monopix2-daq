        ...
        for i, tot_cal in enumerate(tot_cal_array):
            ...
            try:
                ...
                try:
                    ...
                    print(f"slope=a_4par=1/b_3par={1/popt_cal[1]:.3f}")
                    print(f'cost=b_4par=a_3par-c_3par/b_3par={popt_cal[0]-popt_cal[2]/popt_cal[1]:.3f}')
                    print(f'c_4par=a_3par*d_3par={popt_cal[0]*popt_cal[2]:.3f}')
                    print()
                    plt.text(100, 35, f'slope=$a_4par$=1/b={1/popt_cal[1]:.3f}', color='k', fontsize=14)
                    plt.text(100, 35 - 5, f'cost=b_4par=a-c/b={popt_cal[0]-popt_cal[2]/popt_cal[1]:.3f}', color='k', fontsize=14)
                    plt.text(100, 35 - 10, f'c_4par=a*d={popt_cal[0]*popt_cal[2]:.3f}', color='k', fontsize=14)
                    #plt.text(100, 35 - f'slope=a_marilke={1/popt_cal[1]:.3f}', color='k', fontsize=14)
