...
if __name__ == '__main__':
    ...
    # Create a PDF file
    with pdf.PdfPages(os.path.join(args.path, file_name + '_Calibration_curve_fitBonn_DAC.pdf')) as pdf_file:
        # plot 0: tot cal
        for i, tot_cal in enumerate(tot_cal_array):
            ...
            try:
                ...
                try:
                    ...
                    plt.text(10, 40, '$f_{Bonn}(x)=(a/x +1/b)*(x-d)$', color='k', fontsize=14)
