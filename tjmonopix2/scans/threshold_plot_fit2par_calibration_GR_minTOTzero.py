...
def clean_data_debug(results):
    ...
    with PdfPages('tot_distribution_charge_dac_ALL_meanTOTzero.pdf') as pdf:
...
def func(x, a, b, d):
    print(f'called func with d={d:.1f}')
    #d=27.
    return (a / x + 1 / b) * (x - d)
...
def inv_func(tot, a, b, d): # from https://github.com/SiLab-Bonn/tj-monopix2-daq/blob/development/tjmonopix2/analysis/analysis_utils.py
    print(f'called inv_func with d={d:.1f}')
    #d = 27.
...
if __name__ == '__main__':
    ...
    # Create a PDF file
    with pdf.PdfPages(os.path.join(folder_path, base_name + '_tot_calibration_fit2par.pdf')) as pdf_file:
        # Plot 1: S-Curve Plot
        print(' ')
        print('plot s-curves')
        region1 = [0,224, start_row, stop_row]
        ...
        for i, tot_cal in enumerate(tot_cal_array):
            ...
            try:
                ...
                try:
                    ...
                    # Fit vero e propri
                    # popt_cal, pcov_cal = curve_fit(lambda x, a, b: func(x, a, b, d_fixed), x_fit, means_fit,
                    ...
                    if len(x_fit) == 0:
                        ...
                        res = means_fit - func(x_fit, *params)
    ...
    new_file_name = base_name + '_tot_calibration_fit2par.h5'
