...
class elog():
    ...
    """
    # elog types could be used once different types of reports should have a different layout
    elog_types = [
        'Daily report',
        'Special report'
    ]
    ...
    def __init__(
        ...
        # test types of elog reports, important when using different layouts for reports
        # assert self.type in self.elog_types, "Supported types are %s, the type %s does not exist" % (self.elog_types, self.type)
