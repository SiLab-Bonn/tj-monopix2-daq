...
from tjmonopix2_daq.sim.Protocol import WriteRequest, ReadRequest, ReadResponse, PickleInterface, ReadRequestStr


def get_bus():
    bus_name_path = os.getenv("SIMULATION_BUS", "tjmonopix2_daq.sim.BasilBusDriver")
...
def socket_test(dut, debug=False):
    ...
    n_clk = int(os.getenv("SIMULATION_N_CLK", '10'))
    ...
    while True:
        ...
        while True:
            ...
            if isinstance(req, WriteRequest):
                ...
                dut._log.debug("ReadRequestStr: {}".format(req))
